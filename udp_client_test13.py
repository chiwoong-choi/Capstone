...
def process_frame(camera_type, frame, timestamp, pose, silhouette_cache, silhouette_angle, body_parts, colors, previous_knee_angle=None, previous_silhouette=None, angle_threshold=1):
    """
    단일 프레임을 처리하는 함수.
